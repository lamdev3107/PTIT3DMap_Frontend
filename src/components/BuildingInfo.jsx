      ...
      >
        ...
        >
          ...
          <TabsContent value="info" className="p-4">
            ...
            <div className="lg:px-10 md:px-8 px-4 h-full overflow-auto pb-3 ">
              {selectedFloor ? (
                <motion.div
                  initial={{ opacity: 0, y: 20 }}
                  animate={{ opacity: 1, y: 0 }}
                ...
                >
                  <div className="">
                    {/* Title  */}
                    <div className="flex items-center mb-3 group line-clamp-1 ">
                      <h3
                        onClick={() => {
                          if (selectedRoom) {
                            onSelectRoom(null);
                      ...
                      {roomData &&
                        (roomData?.name?.length <= 60 ? (
                          <div className=" flex items-center line-clamp-1">
                            ...
                            <h3
                              className={`font-bold text-blue-950 line-clamp-1`}
                            >
                              {roomData.name}
                            </h3>
                          </div>
                          ...
                          <Tooltip>
                            <TooltipTrigger asChild>
                              <div className="group flex items-center line-clamp-1">
                                <span className="mx-2 group:line-clamp-1">
                                  /
                                </span>
                                <h3
                                  className={`font-bold text-blue-950 line-clamp-1`}
                  ...
                  {roomData?.description &&
                    roomData?.description?.length > 0 && (
                      ...
                      >
                        <div
                          className=" ql-editor text-gray-600 overflow-auto"
                  ...
                  {!roomData ? (
                    <>
                      ...
                      <div className="h-[calc(100vh-410px)] overflow-y-auto">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-2.5 min-h-fit h-2 overflow-y-auto">
